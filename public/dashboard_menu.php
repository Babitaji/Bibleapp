            ...
            <div id="card-stats" class="seaction">
              <div class="row">
                            ...
                            <a href="gallery.php">
                                <div class="card">
                                    <div class="card-content deep-purple white-text">
                                        <p class="card-stats-title"><i class="mdi-social-group-add"></i> IMAGE GALLERY</p>
                                        <h4 class="card-stats-number"><?php echo $total_gallery;?></h4>
                                        <p class="card-stats-compare"><span class="blue-grey-text text-lighten-5">Total Gallery</span>
                                        </p>
                                    </div>
                                    <div class="card-action  blue-grey darken-2">
                                        <div id="clients-bar"></div>

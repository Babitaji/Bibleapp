          	...
          	<div class="container">
            	<div class="row">
              		<div class="col s12 m12 l12">
               			<h5 class="breadcrumbs-title">Image Gallery</h5>
		                <ol class="breadcrumb">
				        ...
				        <form method="get" class="col s12">
				            <div class="row">
								<div class="input-field col s12">
				                    <h5>Image Gallery is not Available</h5>
				                </div>								
				                <div class="input-field col s12">
				                    <a href="add-menu.php" class="btn waves-effect waves-light indigo">Add New Image</a>
				                    &nbsp;
				                    <a href="add-menu-multiple.php" class="btn waves-effect waves-light indigo">Add Multiple Image</a>
				                </div>			              
				             </div>
				        </form>
				    </div>
		                    		...
		                    		<div class="input-field col s12">
										...
										<thead>
											...
											<?php 
												...
												<tbody>
													<tr>
														<td><img src="upload/thumbs/<?php echo $data['image']; ?>" width="80" height="80"/></td>
